...
-- search_all_properties function to fix the location search logic and add the missing property_type column.
...
-- Step 2: Recreate the unified_listings_view with the corrected location logic and the missing property_type column
...
SELECT
    ...
    -- FIX: Added the missing property_type column for projects
...
SELECT
    ...
    -- FIX: Added the missing property_type column for properties
