-- This migration updates the get_property_details function to correctly
-- join and return the `lookup_land_features` for a given property.
-- This is necessary for the edit page to pre-fill the land features checkboxes.
...
SELECT
    jsonb_build_object(
        ...
        -- *** FIX: Added the missing join for land features ***
