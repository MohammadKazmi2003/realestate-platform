...
-- column name from 'parent_location_id' to the correct 'parent_id' and
-- adding logic to search both property and project locations correctly.
...
BEGIN
    ...
    WHERE
        ...
        -- Otherwise, check the correct locations table based on the listing type.
