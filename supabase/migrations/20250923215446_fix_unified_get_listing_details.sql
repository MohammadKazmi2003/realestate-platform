...
BEGIN
    ...
    -- If it's a 'project', use the enhanced project fetching logic
    ELSIF listing_type_from_view = 'project' THEN
        SELECT
            jsonb_build_object(
                ...
                -- *** FIX: Added missing rich text and description fields ***
                ...
                -- *** FIX: Added subquery to fetch and aggregate project-specific FAQs ***
