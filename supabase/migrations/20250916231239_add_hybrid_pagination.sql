...
-- It is backwards-compatible by providing default values for the new page and limit parameters.

DROP FUNCTION IF EXISTS public.search_all_properties(text, text, numeric, numeric, integer, text[], uuid[], integer, integer);
...
ORDER BY ulv.price DESC NULLS LAST
LIMIT p_limit
