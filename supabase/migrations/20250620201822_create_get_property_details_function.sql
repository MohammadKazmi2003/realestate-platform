...
SELECT
    jsonb_build_object(
        ...
        -- Embed related data as JSON objects or arrays
        ...
        -- Aggregate one-to-one details (as a single-element array to match your type)
        'details_residential', (
        ...
        -- Aggregate many-to-many relationships into arrays
